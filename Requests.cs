   ...
   public class Requests
    {
       public string Insert_Department()
        {
            return $"INSERT INTO department (department_id, department_parent_id ) VALUES ({Console.ReadLine()}, {Console.ReadLine()})";
        }
        public string Insert_workers()
        {
            return $@"INSERT INTO workers  (f_name, last_name, department_id, salary_id) VALUES ( @f_name, @l_name, @d_id, @s_id)";
        }
